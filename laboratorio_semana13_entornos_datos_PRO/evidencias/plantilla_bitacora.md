...
|---:|---|---|---|---|---|
| 1 | `KeyError: ...` | ~línea ... | Columna no coincide con el nombre real | Usar el nombre correcto o mapear columnas | Script volvió a ejecutar y calculó el indicador |
| 2 | `SyntaxError: ...` | ~línea ... | Error de sintaxis en `print`/paréntesis | Corregir paréntesis/comillas | Script terminó con los resultados esperados |
| 3 | [agrega si aplica] | ~línea ... | ... | ... | ... |
...
- Cantidad de registros sospechosos: 73
